...
{
    internal static class OpenXmlRegex01
    {
        public static void Main()
        {
            ...
            ProcessWordprocessingDocument(outputDirectory);
            ProcessPresentationDocument(outputDirectory);
        }

        private static void ProcessWordprocessingDocument(DirectoryInfo outputDirectory)
        {
            var sourceDoc = new FileInfo("../../../TestDocument.docx");
            var newDoc = new FileInfo(Path.Combine(outputDirectory.FullName, "Modified.docx"));
            File.Copy(sourceDoc.FullName, newDoc.FullName);

            using WordprocessingDocument wordDocument = WordprocessingDocument.Open(newDoc.FullName, true);

            XElement body = wordDocument
                .MainDocumentPart!
                .GetXDocument()
                .Elements(W.document)
                .Elements(W.body)
            ...
            IEnumerable<XElement> content = body.Elements(W.p).Take(1);
            ...
            content = body.Elements(W.p).Take(1);
            ...
            content = body.Elements(W.p).Skip(2).Take(1);
            ...
            content = body.Elements(W.p).Skip(3).Take(1);
            regex = new Regex(" [a-z.]*$");
            ...
            content = body.Elements(W.p).Skip(4).Take(1);
            regex = new Regex("^Video provides");
            ...
            content = body.Elements(W.p).Skip(8).Take(1);
            regex = new Regex("powerful ");
            ...
            content = body.Elements(W.p).Skip(9).Take(1);
            regex = new Regex("Video provides ");
            ...
            content = body.Elements(W.p).Skip(10).Take(1);
            ...
            content = body.Elements(W.p).Skip(11).Take(1);
            regex = new Regex("Video");
            ...
            content = body.Elements(W.p).Skip(12).Take(1);
            regex = new Regex("powerful ");
            ...
            content = body.Elements(W.p).Skip(13).Take(1);
            regex = new Regex("Video provides ");
            ...
            content = body.Elements(W.p).Skip(14).Take(1);
            regex = new Regex(" to help you prove your point");
            count = OpenXmlRegex.Replace(content, regex, "", null, true, "John Doe");
            ...
            content = body.Elements(W.p).Skip(15).Take(1);
            ...
            content = body.Elements(W.p).Skip(16).Take(1);
            regex = new Regex($"{leftDoubleQuotationMarks}(?<words>{words}){rightDoubleQuotationMarks}");
            ...
            content = body.Elements(W.p).Skip(17).Take(1);
            ...
            content = body.Elements(W.p).Skip(18).Take(1);
            regex = new Regex(@"([1-9])\.\t");
            ...
            content = body.Elements(W.p).Skip(19).Take(1);
            ...
            content = body.Elements(W.p).Skip(20).Take(1);
            ...
            List<XElement> paras = body.Elements(W.p).Skip(21).Take(1).ToList();
            ...
            paras = body.Elements(W.p).Skip(22).Take(1).ToList();
        ...
        private static void ProcessPresentationDocument(DirectoryInfo outputDirectory)
        {
            var sourcePres = new FileInfo("../../../TestPresentation.pptx");
            var newPres = new FileInfo(Path.Combine(outputDirectory.FullName, "Modified.pptx"));
            File.Copy(sourcePres.FullName, newPres.FullName);

            using PresentationDocument pptxDocument = PresentationDocument.Open(newPres.FullName, true);

            foreach (SlidePart slidePart in pptxDocument.PresentationPart!.SlideParts)
            {
                XDocument partXDocument = slidePart.GetXDocument();

                // Replace content
                IEnumerable<XElement> content = partXDocument.Descendants(A.p);
                ...
                partXDocument.Descendants().Attributes(XNamespace.Xml + "space").Remove();
